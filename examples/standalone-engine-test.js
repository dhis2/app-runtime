...
if (!baseUrl || !apiKey) {
	console.error('Usage: node node-engine-test.js --url <baseUrl> --apiKey <key> [--apiVersion <num>]')
	process.exit(2)
}
...
if (typeof fetch === 'undefined') {
	console.error('Global `fetch` is not available. Run this script with Node 18+ or provide a global fetch implementation.')
	process.exit(3)
}
...
async function main() {
	try {
        ...
        console.log('Hello, my name is ' + result.me.firstName + ' ' + result.me.surname)
